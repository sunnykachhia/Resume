...
\item{\cventry{May 2014--Present}{Product Development Engineer}{Aindra Systems Pvt. Ltd.}{Bangalore}{}{\vspace{3pt}
	\begin{itemize}In this Computer Vision based startup I have been working as:
		\item \textbf{Developer:} System Architecting, Web development (Django MVC Framework), API development (Hibernate, RESTEasy), Database Designing (MySQL), Database Handling.
		\item \textbf{Product Management:} Android, iOS and WPF applications, Server Maintenance, Testing and Software Quality Assurance as well.
		\item \textbf{Team Lead:} Product Planner and hiring interns.
		\item \textbf{Impact:} My contribution to the company has major impact on stabilization of the product and in turn increase the customer base.
	\end{itemize}
}}
